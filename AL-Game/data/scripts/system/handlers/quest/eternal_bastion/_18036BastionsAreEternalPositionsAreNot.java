 ...
 *
 */
public class _18036BastionsAreEternalPositionsAreNot extends QuestHandler {

    private final static int questId = 18036;

    public _18036BastionsAreEternalPositionsAreNot() {
        super(questId);
    }
    ...
    public void register() {
        ...
        qe.registerQuestNpc(802008).addOnTalkEvent(questId); //Kvash
    }
