 ...
 * @author Phantom_KNA
 */
public class _25463RecaptureKysisFortress extends QuestHandler {

	private final static int questId = 25463;

	public _25463RecaptureKysisFortress() {
		super(questId);
	}

	@Override
	public void register() {
		qe.registerQuestNpc(805403).addOnTalkEvent(questId); //Lagranjia
